...
| ------------ | -------------- | ------------ | ------ | ------------------------------------------------------------ |
| 儲存媒體     |                | 備份方法     |        | <input type="checkbox">table</input>  <input type="checkbox">view</input> <input type="checkbox">file</input> |
| 更新頻率     |                | 保存期限     |        | <input type="checkbox">object</input> <input type="checkbox">transaction</input> |
| 每筆資料大小 |                | 最大資料筆數 |        |                                                              |
| 版本及日期   |                | 定義檔       |        |                                                              |
